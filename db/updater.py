...
# Download File
print(
    "[i] Downloading zip from github... (Please be patient.. GitHub servers can be painfully slow at times!)\n"
)
...
try:
    ...
    print(
        'Step 2. Copy the contents of "{0}" to the previously created directory!'.format(
            new_dir
        )
    )
    print(
        'Step 3. Copy the contents of "{0}" too.. these contains your log, settings, reports dir and lab dir'
    )
    print(
        "Step 4. Once everything is done delete the following (temporary files and directories):"
    )
    print(
        "[1] {0}\n[2] {1}\n[3] {2}\n[4] {3}".format(
            temp_extra_dir,
