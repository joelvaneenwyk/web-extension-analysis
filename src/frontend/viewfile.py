        ...
        try:
            ...
            try:
                ...
                return render_template(
                    ...
                    error_txt="Something went wrong while reading the file source... error: "
                    + str(e),
                )
            ...
            return render_template(
                ...
                error_txt="I could not find any file with the given file id... well either you tempered with the parameter or something went WRONG!",
            )
