    ...
    try:
        ...
        if scstat[0]:
            ...
            return render_template(
                ...
                error_head="Error getting source code!",
                error_txt="Something went wrong while getting source code of the given url!<br>Error: "
                + scstat[1],
            )
        ...
        return render_template(
            "error.html",
            error_title="Error Encountered!",
            error_head="Invalid URL Parameter",
            error_txt="Something went wrong while decoding url!",
        )
